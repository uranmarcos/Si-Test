        ...
        <div class="<?php echo $visibilidadCajaConsultarPassword?>" id="cajaConsultaPassword">
           <form class="formulario" action="admin.php" method="POST">                    
                <div class="row rowForm">        
                    ...
                    <input class="col-3 campoConsultarPassword" type="text" name="dniConsulta" autocomplete="off" value="">    
                    <div class="offset-1"></div>
                    <div class="offset-2"></div>
                    <input class="col-3 botonInput" type="submit" name="consulta" value="Consultar">
                </div>
                <div class="rowForm <?php echo $colorMensaje?>">
    ...
    <article>
        ...
        <div class="<?php echo $visibilidadCajaResetPassword?>" id="cajaResetPassword">
            ...
            <form class="formulario" action="admin.php" method="POST">
                ...
                <div class="row rowForm <?php echo $colorMensaje?>">
